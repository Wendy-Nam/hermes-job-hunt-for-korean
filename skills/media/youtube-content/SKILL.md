...
- Apify 예산: shared-music과 같은 장부(`state/apify-spend.json`, 월 상한 `HERMES_APIFY_MONTHLY_USD` 기본 $5, 편당 $0.005). 키: `data/.env`의 `GEMINI_API_KEY`·`APIFY_TOKEN`(스크립트가 직접 읽음, 재시작 불필요).
